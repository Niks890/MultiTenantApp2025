...
function resetCreateValidation() {
    $('#createGroupForm .form-control, #createGroupForm .form-select').removeClass('is-invalid').removeClass(
        'is-valid');
    $('#createGroupForm .invalid-feedback').empty();
}
        ...
        .fail(function (xhr) {
            ...
            if (xhr.status === 422 && response.errors) {
                ...
                Swal.fire({
                    icon: 'error',
                    title: 'Lỗi',
                    text: response.message || 'Có lỗi xảy ra khi thêm nhóm cửa hiệu.'
                });
            }
        })
        .always(function () {
