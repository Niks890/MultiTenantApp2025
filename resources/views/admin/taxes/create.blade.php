...
@section('title', __('create_item', ['item' => strtolower(__('tax'))]))
        ...
        <section class="section">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">{{ __('create_item', ['item' => strtolower(__('tax'))]) }}</h4>
                </div>

                <hr class="border-dashed-form">

                <div class="card-body">
                    <form id="taxes-form" action="{{ route('taxes.store') }}" method="POST" enctype="multipart/form-data"
                        novalidate>
                        @csrf
                        <div class="row">
...
@section('js')
    ...
    <script type="module">
        ...
        $(function() {
            new TaxesForm('taxes-form', '{{ route('taxes.index') }}', 'create');
        });
    </script>
@endsection
