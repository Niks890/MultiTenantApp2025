...
@section('title', 'Thêm mới cửa hiệu')
@section('content')
    <x-central.page-header :breadcrumbs="[
        'Quản lý cửa hiệu' => route('tenant.index'),
        __('create') => route('tenant.create'),
    ]" />
    <section class="section">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Thêm mới cửa hiệu</h4>
            </div>
            <hr class="border-dashed-form">
            <div class="card-body">
                <form action="{{ route('tenant.store') }}" method="POST" id="createTenantForm" novalidate
                    ...
                    <div class="row">
                            ...
                            <div class="row align-items-start">
                                ...
                                <div class="col-12 col-lg-10">
                                    <input type="text" name="tenancy_name" id="tenancy_name"
                                        ...
                                        value="{{ old('tenancy_name') }}" required>
                                </div>
                            </div>
                        </div>
                        <div class="col-12 form-group custom-form-group">
                            <div class="row align-items-start">
                                ...
                                <div class="col-12 col-lg-10">
                                    <input type="text" name="tenancy_db_name" id="tenancy_db_name"
                                        ...
                                        value="{{ old('tenancy_db_name') }}" required>
                                </div>
                            </div>
                        </div>
                        <div class="col-12 form-group custom-form-group">
                            <div class="row align-items-start">
                                <label for="tenancy_db_connection"
                                    class="col-12 col-lg-2 col-form-label custom-label text-nowrap">
                                    {{ __('db_connection') }}:<span class="text-danger">*</span>
                                </label>
                                {{-- tam thoi chi ho tro mysql --}}
                                <div class="col-12 col-lg-10">
                                    @php
                                    ...
                                    <select name="tenancy_db_connection" id="tenancy_db_connection"
                                        ...
                                        @foreach ($mysqlConnections as $name => $details)
                                            <option value="{{ $name }}"
                                                {{ old('tenancy_db_connection', config('database.default')) == $name ? 'selected' : '' }}
                            ...
                            <div class="row align-items-start">
                                ...
                                <div class="col-12 col-lg-10">
                                    <input type="text" name="tenancy_db_host" id="tenancy_db_host"
                                        ...
                                        value="{{ old('tenancy_db_host') ?? '127.0.0.1' }}" required>
                                </div>
                            </div>
                        </div>
                        <div class="col-12 form-group custom-form-group">
                            <div class="row align-items-start">
                                ...
                                <div class="col-12 col-lg-10">
                                    <input type="number" name="tenancy_db_port" id="tenancy_db_port"
                                        ...
                                        value="{{ old('tenancy_db_port') ?? 3306 }}" min="1" max="65535"
                                        required>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row align-items-start">
                                ...
                                <div class="col-12 col-lg-10">
                                    <input type="text" name="tenancy_db_username" id="tenancy_db_username"
                                        ...
                                        value="{{ old('tenancy_db_username') }}" required autocomplete="off">
                                </div>
                            </div>
                        </div>
                        <div class="col-12 form-group custom-form-group">
                                    ...
                                    <div class="input-group flex-nowrap">
                                        <div class="input-container position-relative flex-grow-1">
                                            <input type="text" id="tenancy_db_password"
                                                ...
                                                value="{{ old('tenancy_db_password') ?? '' }}" required
                                                autocomplete="off">
                        ...
                        <div class="col-12 form-group custom-form-group">
                            <div class="row align-items-start">
                                <label for="tenancy_access_key"
                                    class="col-12 col-lg-2 col-form-label custom-label text-nowrap">
                                    {{ __('access_key') }}:<span class="text-danger">*</span>
                                </label>
                                <div class="col-12 col-lg-10">
                                    <div class="input-group flex-nowrap">
                                        <div class="input-container position-relative flex-grow-1">
                                            <input type="text" id="tenancy_access_key"
                                                ...
                                                value="{{ old('tenancy_access_key') ?? '' }}" required
                                                autocomplete="off">

                                            <button class="generate-pass-btn border-0 p-0" type="button"
                                                id="generate-access-key-btn" title="Tự sinh access key">
                                                <i class="fas fa-sync-alt"></i>
                                            </button>
                                        </div>
                        ...
                        <div class="col-12 form-group custom-form-group">
                            <div class="row align-items-start">
                                <label for="tenancy_hash_code"
                                    class="col-12 col-lg-2 col-form-label custom-label text-nowrap">
                                    {{ __('hash_code') }}:<span class="text-danger">*</span>
                                </label>
                                <div class="col-12 col-lg-10">
                                    <div class="input-group flex-nowrap">
                                        <div class="input-container position-relative flex-grow-1">
                                            <input type="text" id="tenancy_hash_code"
                                                ...
                                                value="{{ old('tenancy_hash_code') ?? '' }}" required autocomplete="off">

                                            <button class="generate-pass-btn border-0 p-0" type="button"
                                                id="generate-hash-code-btn" title="Tự sinh hash code">
                                                <i class="fas fa-sync-alt"></i>
                                            </button>
                                        </div>
                        ...
                        <div class="col-12 form-group custom-form-group">
                            <div class="row align-items-start">
                                ...
                                <div class="col-12 col-lg-10">
                                    <input type="url" name="tenancy_domain" id="tenancy_domain"
                                        placeholder="Nhập tên miền" class="form-control"
                                        value="{{ old('tenancy_domain') }}" required>
                            ...
                            <div class="row align-items-start">
                                ...
                                <div class="col-12 col-lg-10">
                                    <select name="tenancy_group" id="tenancy_group" class="form-control form-select"
                                        placeholder="Chọn nhóm cửa hiệu">
                                        <option value="">Không phân nhóm</option>
                                        @foreach ($groups as $group)
                                            <option value="{{ $group->id }}"
                                                {{ old('tenancy_group') == $group->id ? 'selected' : '' }}>
                                                {{ $group->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                    ...
                                    <select name="tenancy_admin" id="tenancy_admin" class="form-control form-select"
                                        ...
                                        @foreach ($adminTenants as $admin)
                                            <option value="{{ $admin->id }}"
                                                {{ old('tenancy_admin') == $admin->id ? 'selected' : '' }}>
                                ...
                                <div class="col-12 col-lg-10 d-flex flex-column gap-2">
                                    <div class="form-check mt-2">
                                        ...
                                        <label class="form-check-label" for="enable_copy_info">
                                            <p>Sao chép thông tin cửa hiệu khác</p>
                                        </label>
                                    </div>
                        ...
                        <div class="col-12 form-group custom-form-group">
                            <div class="row align-items-start">
                                <label for="tenancy_logo" class="col-12 col-lg-2 col-form-label custom-label text-nowrap">
                                    {{ __('tenant_logo') }}:
                                </label>
                                <div class="col-12 col-lg-10">
                                    <input type="file" accept="image/*" name="tenancy_logo" id="tenancy_logo"
                                        data-cropper-target="createTenantForm" data-preview-target="#logoPreview"
                                        data-hidden-input="cropped_logo" class="form-control" data-existing-logo=""
                        ...
                        <div class="col-12 form-group custom-form-group">
                            <div class="row align-items-start">
                                ...
                                <div class="col-12 col-lg-10">
                                    <input type="url" name="tenancy_tiktok_url" id="tenancy_tiktok_url"
                                        placeholder="Nhập liên kết tiktok" class="form-control"
                                        value="{{ old('tenancy_tiktok_url') }}">
                                </div>
                            </div>
                        </div>
                        <div class="col-12 form-group custom-form-group">
                            <div class="row align-items-start">
                                ...
                                <div class="col-12 col-lg-10">
                                    <input type="url" name="tenancy_ig_url" id="tenancy_ig_url"
                                        placeholder="Nhập liên kết instagram" class="form-control"
                                        value="{{ old('tenancy_ig_url') }}">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row align-items-start">
                                ...
                                <div class="col-12 col-lg-10">
                                    <input type="text" name="tenancy_address" id="tenancy_address"
                                        ...
                                        class="form-control" value="{{ old('tenancy_address') }}">
                                </div>
                            </div>
                        </div>
                    </div>
...
@section('js')
    ...
    <script src="{{ asset('assets/custom/js/tenant/autofill-db.js') }}"></script>

    <script>
        $(function() {
            initializePasswordGeneration('#tenancy_db_password', 8);
            setupGeneratePasswordButton('#generate-password-btn', '#tenancy_db_password', 8);

            initializePasswordGeneration('#tenancy_access_key', 8);
            setupGeneratePasswordButton('#generate-access-key-btn', '#tenancy_access_key', 8);

            initializePasswordGeneration('#tenancy_hash_code', 8);
            setupGeneratePasswordButton('#generate-hash-code-btn', '#tenancy_hash_code', 8);
        });
    </script>
@endsection
