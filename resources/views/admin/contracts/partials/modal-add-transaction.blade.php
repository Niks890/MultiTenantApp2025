            ...
            <form id="formAddTransaction" novalidate enctype="multipart/form-data">
                    ...
                    <div class="row g-3">
                        <div class="col-12 col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" id="amount_display" inputmode="numeric" class="form-control"
                                    placeholder="VD: 500.000" required>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="payment_date_display" class="form-control"
                                    placeholder="dd/mm/yyyy" readonly style="background:#fff; cursor:pointer;">
                                <input type="hidden" name="payment_date" id="payment_date_raw">
                            ...
                            <div class="mb-3">
                                ...
                                <div id="payment_method_error" class="invalid-feedback" style="margin-top: -20px;">
                        ...
                        <div class="col-12 col-md-6">
                            <label class="form-label">{{ __('Ảnh hoá đơn giao dịch') }}: <span
                            ...
                            <div id="file_path_error" class="invalid-feedback"></div>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-outline-secondary" data-bs-dismiss="modal">
                        <i class="fa fa-arrow-left me-1"></i>{{ __('Đóng') }}
                    </button>
