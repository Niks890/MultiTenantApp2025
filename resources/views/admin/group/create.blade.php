...
@section('title', __('create_item', ['item' => strtolower(__('group_tenant'))]))
@section('content')
    ...
    <section class="section">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">{{ __('create_item', ['item' => strtolower(__('group_tenant'))]) }}</h4>
            </div>
            <hr class="border-dashed-form">
            <div class="card-body">
                <form action="{{ route('group.store') }}" method="POST" id="createGroupForm" novalidate>
                    @csrf
                    <div class="row">
                            ...
                            <div class="row align-items-start">
                                ...
                                <div class="col-12 col-lg-10">
                                    <input type="text" name="group_name" id="group_name"
                                        ...
                                        class="form-control" value="{{ old('group_name') }}" required>
                        ...
                        <div class="col-12 form-group custom-form-group">
                            <div class="row align-items-center">
                                ...
                                <div class="col-12 col-lg-10">
                                    <textarea name="group_description" id="group_description" cols="5" rows="5"
                                        placeholder="{{ __('enter', ['item' => strtolower(__('description'))]) }}" class="form-control">{{ old('group_description') }}</textarea>
                                    <div class="invalid-feedback" id="group_description_error"></div>
                                </div>
                            </div>
                        </div>
                    </div>
...
@section('js')
    ...
    <script src="{{ asset('assets/custom/js/group-tenant/create.js') }}"></script>
@endsection
